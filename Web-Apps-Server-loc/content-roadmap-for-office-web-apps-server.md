...
<p>Чтобы оценить работу Сервер Office Web Apps, вы можете <a href="deploy-office-web-apps-server.md">развернуть ферму сервера Office Web Apps с одни сервером в тестовой среде</a>. Или, чтобы развернуть что-нибудь более надежное, вы можете <a href="deploy-office-web-apps-server.md">развернуть ферму сервера Office Web Apps, использующую HTTPS</a>. Если необходимо поддерживать большое число пользователей, можно <a href="deploy-office-web-apps-server.md">развернуть многосерверную ферму сервера Office Web Apps с балансировкой нагрузки, которая использует HTTPS</a>.</p>
<p><br />
</p>
